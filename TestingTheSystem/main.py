...
def unit_test():
    ...
    result = sell_product('banana', 10)  # Selling 200 should not raise an error - if it does, the sell_product function needs fixing.
    ...
    assert result == "Insufficient stock", "No stock of that product?"
